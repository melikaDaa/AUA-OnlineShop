...
using AUA.ProjectName.Services.ListService.Shop.Services;
...
namespace AUA.ProjectName.WebUi.RegistrationServices
{
    ...
    public static class ListService
    {
        public static void RegistrationListService(this IServiceCollection services)
        {
            ...
            services.RegisterShopListService();
        }
        ...
        public static void RegisterShopListService(this IServiceCollection services)
        {
